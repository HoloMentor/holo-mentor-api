...
public class QuizController {
    ...
    // @GetMapping("{class_id}/{user_id}/get_quizzes")
    // public ResponseEntity<Object> getQuizzesNew(@PathVariable Long class_id,
    ...
    // ResponseEntity<Object> quizzes =
    // quizService.getQuizzesByUserIdAndClassId(user_id, class_id);
    ...
    // // "completedQuizzes", quizList.stream().filter(q ->
    // isCompletedQuiz(q)).count()
    // // )
    // );
    ...
    // // .filter(quiz -> (difficulty == null ||
    // quiz.getDifficulty().equalsIgnoreCase(difficulty)) &&
    ...
    // quizzes.stream().filter(Quiz::getPublished).count();
    // // // Map<String, Long> quizzesByDifficulty = quizzes.stream()
    // // // .collect(Collectors.groupingBy(Quiz::getDifficulty,
    // Collectors.counting()));
    ...
    // public ResponseEntity<Object> assignQuizToUsers(@PathVariable Long quiz_id,
    // @RequestBody List<Long> userIds) {
    // quizService.assignQuizToUsers(quiz_id, userIds);
    // return ResponseEntity.ok(Map.of("message", "Quiz assigned successfully",
    // "userIds", userIds));
    // }

    // // @PostMapping("/bulk_create")
    // // public ResponseEntity<Object> bulkCreateQuizzes(@RequestBody List<Quiz>
    // quizzes) {
    // // List<Quiz> createdQuizzes = quizzes.stream()
    // // // .map(quizService::createQuiz)
    // // .collect(Collectors.toList());
    // // return ResponseEntity.ok(Map.of("message", "Bulk quiz creation
    // successful", "quizzes", createdQuizzes));
    // // }

    // @PostMapping("/generate_random")
    // public ResponseEntity<Object> generateRandomQuiz(@RequestBody Map<String,
    // Object> criteria) {
    // // @SuppressWarnings("unused")
    ...
    // @PostMapping("/archive")
    // public ResponseEntity<Object> archiveOldQuizzes(@RequestBody Map<String,
    // Object> params) {
    // Date archiveBefore = new Date((Long) params.get("archiveBefore"));
    // List<Quiz> archivedQuizzes =
    // quizService.archiveQuizzesBeforeDate(archiveBefore);
    // return ResponseEntity
    // .ok(Map.of("message", "Quizzes archived successfully", "archivedQuizzes",
    // archivedQuizzes));
    // }
}